...
<TheResult>
	<h3 class="text-xl text-gray-200 md:text-2xl">
		...
		<br />
		Let's talk! Discover how Stack IT can drive your digital transformation and help you reach new heights.
		digital transformation and help you reach new heights.
	</h3>
</TheResult>
