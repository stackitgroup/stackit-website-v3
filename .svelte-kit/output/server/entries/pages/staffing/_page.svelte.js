...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-12kpxux_START -->${$$result.title = `<title>Staffing</title>`, ""}<meta name="og:description" content="Stackit Website"><!-- HEAD_svelte-12kpxux_END -->`, ""} ${validate_component(Hero_staffing, "HeroStaffing").$$render($$result, {}, {}, {})} ${validate_component(Some_of_our_clients, "SomeOfOurClients").$$render($$result, {}, {}, {})} ${validate_component(Who_we_are, "WhoWeAre").$$render($$result, {}, {}, {})} ${validate_component(Staffing_innovation, "StaffingInnovation").$$render($$result, {}, {}, {})} ${validate_component(Why_we_excel, "WhyWeExcel").$$render($$result, {}, {}, {})} ${validate_component(How_to_work_together, "HowToWorkTogether").$$render($$result, {}, {}, {})} ${validate_component(The_result, "TheResult").$$render($$result, {}, {}, {})}`;
});
export {
  Page as default
};
