...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_svelte_awesome: string;
	...
	export const npm_package_devDependencies_svelte_recaptcha_v2: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_svelte_awesome: string;
		...
		npm_package_devDependencies_svelte_recaptcha_v2: string;
